<script>
  ...
  import { walletService, walletConnected, walletAddress, networkCorrect } from '$lib/stores/wallet.js';
      ...
      {:else if !$networkCorrect}
        <div class="flex items-center justify-center min-h-screen p-4">
          <div class="max-w-md w-full bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 text-center">
            ...
            <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-2">Wrong Network</h2>
            <p class="text-gray-600 dark:text-gray-400 mb-4">
              Please switch to Reactive Network to continue
            </p>
            <button 
              on:click={() => walletService.switchToReactiveNetwork()}
